                    ...
                    <div style={{ backgroundColor: '#23202A' }} className="  w-5/6  rounded-lg  flex flex-row justify-between items-center">
                        ...
                        {userData.id == jobDetail.userId ? (
                            <div className=" flex flex-row">
                                ...
                                <button onClick={deleteJobHandler} style={{ background: '#23202A' }} className="text-red-900 border-2 border-red-900 hover:text-red-500 hover:border-red-500 hover:border-opacity-100 p-2 rounded-3xl flex flex-row items-center space-x-2 mr-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
