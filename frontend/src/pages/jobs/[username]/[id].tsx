        ...
        <>
            ...
            <div className="bg-[#1E1B24] flex flex-col items-center justify-center space-y-4">
                ...
                <div className=" flex flex-col w-full items-center justify-center mt-28">
                    ...
                    <div className="bg-[#23202A]  w-5/6  rounded-lg  flex flex-row justify-between items-center">
                        ...
                        {userData.id == jobDetail.userId ? (
                            <div className=" flex flex-row">
                                <button className="bg-[#23202A] text-gray-500 hover:text-gray-50 border-2 border-gray-500  hover:border-2  hover:border-gray-300 hover:border-opacity-100 p-2 rounded-3xl flex flex-row items-center space-x-2 mr-5">
                                ...
                                <button onClick={deleteJobHandler} className="bg-[#23202A] text-red-900 border-2 border-red-900 hover:text-red-500 hover:border-red-500 hover:border-opacity-100 p-2 rounded-3xl flex flex-row items-center space-x-2 mr-5">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                ...
                <div className="flex flex-row items-start justify-center space-x-4 w-5/6 pb-20">
                    ...
                    <div className="flex flex-col w-4/12 space-y-4 ">
                        <div className="bg-[#23202A] w-full rounded-lg flex flex-col pb-6 items-center">
