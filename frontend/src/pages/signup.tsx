    ...
    <>
      ...
      <section style={{ background: '#19181F' }}>
        <div className="flex flex-row items-center justify-center space-x-32  px-6 py-8 pb-36">
          ...
          <div className="w-full  rounded-3xl  border-none  md:mt-24 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className="space-y-16">
                <div className="space-y-4 md:space-y-6" >
                  ...
                  <p className="text-xl font-medium leading-tight tracking-tight text-gray-400">
                    Get in touch with us!
                    Write to us if you have questions, suggestions or cooperation offers.
                  </p>
                </div>
                ...
                <div className="space-y-12">
                  <div className="flex flex-row space-x-12">
                    <div>
                      <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-50 pb-2">
                        E-Mail
                      </h1>
                      <p className="text-lg font-medium leading-tight tracking-tight text-gray-400">
                        bytetask@support.com
                      </p>
                ...
                <div className=" space-y-5 ">
                  <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-50 ">
                    Follow us
                  </h1>
                  <div className="flex flex-row space-x-10">
                    <a href="#" style={{ background: '#23202A' }} className="text-gray-500 hover:text-gray-50 border border-2 border-gray-300 border-opacity-0  hover:border hover:border-2  hover:border-gray-300 hover:border-opacity-100  p-2 rounded-3xl ">
          ...
          <div style={{ backgroundColor: '#23202A' }} className="w-full  rounded-3xl  border-none shadow-2xl dark:border md:mt-24 sm:max-w-md xl:p-0 ">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <button
                  type="submit"
                  className=" w-full text-opacity-0 bg-white hover:bg-black hover:bg-opacity-10 hover:text-white border border-2 border-gray-50 focus:ring-1 focus:outline-none focus:ring-white font-medium rounded-full text-sm px-6 py-3 text-center transition duration-300 ease-in-out font-bold"
                >
                  Create An Account
                </button>
