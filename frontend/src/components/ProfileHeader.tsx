...
export default function ProfileHeader() {
  ...
  return (
    ...
    <div className=" flex flex-col w-full items-center justify-center mt-28">
      ...
      <div className="bg-[#23202A] h-28 w-5/6  rounded-bl-lg rounded-br-lg flex flex-row justify-between items-center">
        ...
        <div className="flex flex-row p-4 md:p-0 mt-4 font-medium rounded-lg mr-16 space-x-8">
          ...
          <a href="#" className="bg-[#23202A] text-gray-500 hover:text-gray-50 border-2 border-gray-500  hover:border-2  hover:border-gray-300 hover:border-opacity-100 p-2 rounded-3xl flex flex-row items-center space-x-2">
